...
val GrayBorder = Color(0xFFE0E0E0)         // bordas discretas

// ===== Estados =====
val SuccessGreen = Color(0xFF2E7D32)       // confirmações, entregue, sucesso
val SuccessGreenLight = Color(0xFFE6F4EA)  // fundo de badges de sucesso
val ErrorRed = Color(0xFFD32F2F)           // erros, alertas, remover
val ErrorRedLight = Color(0xFFFDEAEA)      // fundo de badges de erro
val WarningAmber = Color(0xFFF9A825)       // estoque baixo, avisos
